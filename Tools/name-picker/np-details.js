// np-details.js — read-only access to the per-student detail Class Roster Hub
// keeps beside the shared roster.
//
...
export default { DETAILS_KEY, normalize, parseDetails, loadDetails, lookupDetail, displayName };
